"""Health check and status endpoints for the data parser application.
...
class HealthCheck:
    ...
    def __init__(self, app_name: str = "data-parser-app") -> None:
...
def create_health_app(app_name: str = "data-parser-app") -> SimpleWSGIRouter:
