...
help:
	...
	@echo "  run                 - Run the parser (use ARGS=<parser_id>)"
	...
	@echo "  make test PYTEST_ARGS='-v -s tests/test_parser.py'"
	...
	@echo "  ARGS               - User arguments for non-test targets (e.g., parser IDs)"
